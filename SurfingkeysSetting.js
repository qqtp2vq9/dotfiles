...
// Search
addSearchAliasX('gi', 'github検索', 'https://github.com/search?q={0}&type=code')
addSearchAliasX('dio', 'DeveloperIO検索', 'https://dev.classmethod.jp/?s={0}')
...
mapkey('YY', '#7Copy title and link to multi line', () => {
